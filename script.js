...
// Desenha os objetos ao canvas
    draw: function () {
        ...
        // Coloca a fonte padrao do jogo no centro
        this.context.font = '100px Courier New';
        this.context.textAlign = 'center';

        // Desenha o scordo jogador
        ...
        // Desenha score do segundo jogador
        this.context.fillText(
    ...
    menu: function () {
            // Desenha o estagio inicial de todos os objetos do jogo
            pong.draw();

            // Altera a cor do estilo de fonte do canvas
            this.context.font + '50px Courier New';
            this.context.fillStyle = this.color;

            // Desenha o retangulo atrás do texto 'Press any key to begin'
            this.context.fillRect(
            ...
            // Altera a cor de prenchimentodo canvas;
            this.context.fillStyle = '#ffffff';

            // Desenha o texto 'Press to any key to begin
    ...
    endGameMenu: function (text) {
                ...
                // Altere a cor do preenchimento da fonte;
    ...
    update: function () {
        if (!this.over) {
			...
			// controla a colisao da bola com a raquete do computador
